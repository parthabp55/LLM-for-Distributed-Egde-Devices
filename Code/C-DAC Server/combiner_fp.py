...
# # Set device to CPU
# device = "cpu"  # Force the device to CPU
...
# def load_model_fp(model_path, precision="fp16"):
...
#         model_path,
#         torch_dtype=dtype,
#         device_map="cpu"  # Set device map to CPU explicitly
#     ).eval()
...
#     phi_model, phi_tokenizer = load_model_fp(cfg["phi_model"])
#     pythia_model, pythia_tokenizer = load_model_fp(cfg["pythia_model"])
#     refiner_model, refiner_tokenizer = load_model_fp(cfg["refiner_model"], precision="bf16")
